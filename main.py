...
#rota para exibir o primeiro filme
@app.route("/movies")
def get_movie():
...
#rota para curtit o filme atual
@app.route("/like")
def liked_movie():
    global all_movies
    movie_data = assign_val()
...
#rota para filmes nao assistidos
...
def popular_movies():
    ...
    for index, row in output.iterrows():
        _p = {
            ...
            "release_data": row['release_date'] or "N/A",
...
#filmes recomendados com base nos filmes curtidos
@app.route("/recommended_movies")
def recommended_movies():
    global liked_movies
    col_names=['original_title','poster_link','release_data', 'runtime','weighted_rating']
